...
export const HeroParallax = ({
  ...
  const thirdRowRef = React.useRef(null);
  ...
  const { scrollYProgress: thirdRowScroll } = useScroll({
  target: thirdRowRef,
  offset: ["start end", "end start"],
});

const thirdRowTranslate = useSpring(
  useTransform(thirdRowScroll, [0, 1], [500, -500]),
  springConfig
);
...
export const ProductCard = ({
  ...
  return (
    <motion.div
      ...
      key={product.title}
      className="group/product h-96 w-[30rem] relative shrink-0 shadow-[0_0_15px_#a855f7]/50"
    >
