  ...
  return (
    <>
      <AnimatePresence>
        {open && (
          <div className="fixed inset-0 z-50 h-screen overflow-auto">
            ...
            >
              <button
                className="sticky top-4 right-0 ml-auto flex h-8 w-8 items-center justify-center rounded-none bg-black dark:bg-white"
                onClick={handleClose}
              >
      ...
      <motion.button
        layoutId={layout ? `card-${card.title}` : undefined}
        onClick={handleOpen}
        className="group relative z-10 flex w-[60vw] h-[70vh] flex-col items-start justify-start overflow-hidden bg-gray-100 dark:bg-neutral-900"
      >
        ...
        <div className="relative z-10 w-full h-full">
          ...
          />
          <div className="absolute inset-0 z-20 bg-black/0 group-hover:bg-black/50 transition duration-300"></div>
          </div>
      </motion.button>
    </>
  );
